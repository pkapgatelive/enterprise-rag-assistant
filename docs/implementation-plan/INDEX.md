...
| 2 | [phase-02-embeddings-vector-db.md](phase-02-embeddings-vector-db.md) | Embeddings & Vector Database | Generate embeddings via Amazon Titan Text Embeddings V2 and index them into FAISS (local) and Amazon OpenSearch Serverless (cloud) |
...
| Vector DB (cloud) | Amazon OpenSearch Serverless |
| RAG orchestration | LangChain + LangChain-Community |
| Backend | FastAPI + Uvicorn + Pydantic v2 |
| Frontend | React 18 + TypeScript + Tailwind CSS |
| Document storage | Amazon S3 |
| Metadata / history | PostgreSQL (via SQLAlchemy + asyncpg) |
| Containerisation | Docker + Docker Compose |
| CI/CD | GitHub Actions |
| Cloud orchestration | Amazon ECS (Fargate) |
